...
const StartInterviewPage = () => {
  ...
  const handleStart = () => {
    ...
    window.location.href = `/interview?round=${round}&role=${role}`;
  };
  useEffect(() => {
    if (isLoggedIn===false) {
      router.replace("/");
        ...
        <div className="w-[95%] md:w-[70%] lg:w-[55%] bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-6 space-y-8">
          <div className="flex items-center gap-4 border-b pb-6">
            ...
            <div>
              ...
              <div className="flex gap-6 mt-2 text-sm text-gray-600">
                ...
                <span className="flex items-center justify-center gap-2 ">
                  <FaStar size={20} className="text-yellow-500" /> Avg Score:{" "}
                  {userdata.avg || 0} %
                </span>
              </div>
            </div>
          ...
          <div className="bg-gray-50 border rounded-xl p-5 shadow-sm space-y-3">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 text-sm">
              ...
              <li>You will receive instant AI feedback after completion.</li>
            </ul>
          </div>
